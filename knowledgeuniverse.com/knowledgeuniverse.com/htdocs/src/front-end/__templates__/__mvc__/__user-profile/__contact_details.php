...
<i>Its simply help us to get in thouch with you shortly!</i></h6>
    ...
    ?>
      ...
      <label for="inputFirst" class="sr-only text-white">Country Code</label>
      <input name="name" type="user" id="contry_code" class="form-control bg-dark text-white" 
      ...
      <label for="dateOfBirth" class="sr-only text-white">Contact Email</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
