...
<i>Its help us to shortly verify you</i></h6>

      <h3 class="h5 mb-3 mt-3 font-weight-normal text-white">ID Verification</h3>
    ...
    ?>
      ...
      <label for="inputFirst" class="sr-only text-white">Id Proof</label>
      <input name="name" type="user" id="first_name" class="form-control bg-dark text-white" 
      placeholder="Id Proof" required="" autofocus="">

      <label for="inputLast" class="sr-only text-white">ID Number</label>
      <input name="name" type="user" id="last_name" class="form-control bg-dark text-white" 
      placeholder="ID Number" required="" autofocus="">

      <label for="dateOfBirth" class="sr-only text-white">Upload ID Proof</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
      placeholder="Upload ID Proof" required="">

    <div class="text-center">
    <div class="row"><div class="col"></div>
    <div class="col">
    <button class="btn btn-outline-primary ps-1 pe-1 p-1 mt-4 btn-sm text-primary btn-block" type="button"><b>Submit All</b></button>
    </div>
    <div class="col"></div>
    </div></div>
...
<a class="link-underline link-underline-opacity-0" href="/personal_details"><span style='font-size:23px; color:dimgray;'>&#9679;</span></a>
    ...
    <a class="link-underline link-underline-opacity-0" href="/id_verification"><span style='font-size:23px; color:blue;'>&#9679;</span></a>
</span>
</div>

<div class="text-center mb-5">
<span>
<a class="btn ms-5 me-5 p-1 mt-3 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/address_details"><b>Back</b></a></button>
...
<a class="btn ms-5 me-5 mt-3 p-1 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/skill"><b>Next</b></a><b></b></button>
</span>
</div>
