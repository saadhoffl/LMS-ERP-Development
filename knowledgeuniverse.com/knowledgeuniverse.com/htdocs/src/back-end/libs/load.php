...
include_once 'includes/common/core/UserData.class.php';

include_once 'includes/common/skill/Skill.class.php';

include_once 'includes/web/core/Session.class.php';
include_once 'includes/web/core/UserSession.class.php';
include_once 'includes/web/core/WebAPI.class.php';
