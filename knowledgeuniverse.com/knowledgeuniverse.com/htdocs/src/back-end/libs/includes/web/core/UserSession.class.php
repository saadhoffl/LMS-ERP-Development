...
class UserSession{
    ...
    public static function authenticate($user, $pass, $fingerprint = null){
        ...
        if($username){
            ...
            VALUES ('$user->uid', '$client_id', '$username', '$access_token', $access_valid_for, now(), now(), '$refresh_token', $refresh_valid_for, '$scope', '$ip', '$agent', '$ip_agent', '1', '$fingerprint')";
    ...
    public function is_working_api(){
        ...
        $data = new GetSetDataHelper("session", $this->id, false, null, $this->uid, false, $this->refresh_token, true, $this->client_id, false);
