...
<i>Its help us to shortly reach you!!</i></h6>
      ...
      <h3 class="h5 mb-3 mt-3 font-weight-normal text-white">Address details</h3>
    ...
    ?>
      ...
      <label for="inputFirst" class="sr-only text-white">House No / Name</label>
      <input name="name" type="user" id="first_name" class="form-control bg-dark text-white" 
      placeholder="House No / Name" required="" autofocus="">

      <label for="inputLast" class="sr-only text-white">Area, Colony</label>
      <input name="name" type="user" id="last_name" class="form-control bg-dark text-white" 
      placeholder="Area, Colony" required="" autofocus="">

      <label for="dateOfBirth" class="sr-only text-white">State</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
      placeholder="State" required="">

      <label for="dateOfBirth" class="sr-only text-white">City</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
      placeholder="City" required="">

      <label for="dateOfBirth" class="sr-only text-white">Pincode</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
...
<a class="link-underline link-underline-opacity-0" href="/personal_details"><span style='font-size:23px; color:dimgray;'>&#9679;</span></a>
    ...
    <a class="link-underline link-underline-opacity-0" href="/address_details"><span style='font-size:23px; color:blue;'>&#9679;</span></a>
...
<span>
<a class="btn ms-5 me-5 p-1 mt-3 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/career_details"><b>Back</b></a></button>
<a class="btn ms-5 me-5 mt-3 p-1 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/id_verification"><b>Next</b></a><b></b></button>
</span>
</div>
