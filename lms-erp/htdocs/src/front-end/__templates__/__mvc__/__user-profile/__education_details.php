...
<i>Its help us to Know your Education level!</i></h6>

      <h3 class="h5 mb-3 mt-4 font-weight-normal text-white">Education details</h3>
    ...
    ?>
      ...
      <label for="inputFirst" class="sr-only text-white">Education Level</label>
      <input name="name" type="user" id="first_name" class="form-control bg-dark text-white" 
      placeholder="Education Level" required="" autofocus="">

      <label for="inputLast" class="sr-only text-white">Name of School / College</label>
      <input name="name" type="user" id="last_name" class="form-control bg-dark text-white" 
      placeholder="Name of School / College" required="" autofocus="">

      <label for="dateOfBirth" class="sr-only text-white">Location of School / College</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
      placeholder="Location" required="">

      <label for="dateOfBirth" class="sr-only text-white">Year of Passing</label>
      <input name="date_of_birth" type="user" id="date_of_birth" class="form-control bg-dark text-white" 
...
<a class="link-underline link-underline-opacity-0" href="/personal_details"><span style='font-size:23px; color:dimgray;'>&#9679;</span></a>
    ...
    <a class="link-underline link-underline-opacity-0" href="/education_details"><span style='font-size:23px; color:blue;'>&#9679;</span></a>
...
<span>
<a class="btn ms-5 me-5 p-1 mt-3 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/contact_details"><b>Back</b></a></button>
<a class="btn ms-5 me-5 mt-3 p-1 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/career_details"><b>Next</b></a><b></b></button>
</span>
</div>
