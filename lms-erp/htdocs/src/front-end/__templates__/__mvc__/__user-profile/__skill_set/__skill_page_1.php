...
<i>Its help us to train you better version of you</i></h6>
    ...
    ?>
      ...
      placeholder="Language's you know" required="" autofocus="">
      ...
      placeholder="Mother tounge" required="" autofocus="">
      ...
      placeholder="Level of English Speeking" required="">
...
<span>
<a class="link-underline link-underline-opacity-0" href="/skill_page_1.php"><span style='font-size:23px; color:blue;'>&#9679;</span></a>
...
<span>
<a class="btn ms-5 me-5 p-1 mt-3 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/skill.php"><b>Back</b></a></button>
