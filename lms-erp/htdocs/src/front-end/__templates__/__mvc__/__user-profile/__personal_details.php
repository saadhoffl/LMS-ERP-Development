...
<h6 class="mb-5 text-start text-center text-secondary font-weight-normal">Complete your details,
<i>give your personal details</i></h6>

      <h3 class="h5 mb-3 font-weight-normal text-white">Personal details</h3>
    ...
    ?>
      ...
      <label for="inputFirst" class="sr-only text-white">First Name</label>
      <input name="name" type="user" id="first_name" class="form-control bg-dark text-white" 
      placeholder="First Name" required="" autofocus="">

      <label for="inputLast" class="sr-only text-white">Last Name</label>
      <input name="name" type="user" id="last_name" class="form-control bg-dark text-white" 
      placeholder="Last Name" required="" autofocus="">

      <label for="dateOfBirth" class="sr-only text-white">Date of Birth</label>
    ...
    <div class="col">
    <button class="btn btn-outline-primary ps-2 pe-2 p-1 mt-5 btn-sm text-primary btn-block" type="button"><b>Submit</b></button>
    </div>
    <div class="col"></div>
    </div></div>
...
<span>
    <a class="link-underline link-underline-opacity-0" href="/personal_details"><span style='font-size:20px; color:blue;'>&#9679;</span></a>
    <a class="link-underline link-underline-opacity-0" href="/contact_details"><span style='font-size:20px; color:dimgray;'>&#9679;</span></a>
...
<span>
<a class="btn mb-3 me-5 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/"><b>Finish later !</b></a></button>
<a class="btn mb-3 ms-5 btn-sm text-primary btn-block link-underline link-underline-opacity-0" href="/contact_details"><b>Next</b></a><b></b></button>
</span>
</div>
